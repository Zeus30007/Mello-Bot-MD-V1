...
│
└─ 𓇽ᴍᴇʟʟᴏ'ꜱ ɪɴꜰᴏ𓇻        
𓇻 ᴍᴇʟʟᴏ ꜱᴘᴇᴇᴅ : ${latensie.toFixed(4)} miliseconds
𓇻 ᴍʏ ᴏᴡɴᴇʀ: ${ownernumber}
𓇻 ᴘʀᴇꜰɪx :  NO-PREFIX 
𓇻 ᴄᴜʀʀᴇɴᴛʟʏ ɪɴ : ${XeonBotInc.public ? 'Public' : `Self`}
𓇻 ʜᴏꜱᴛ : ${os.hostname()}
𓇻 ᴘʟᴀᴛꜰᴏʀᴍ : ${os.platform()}
𓇻 ʀᴀɴᴛɪᴍᴇ : ${runtime(process.uptime())}
└─ 𓇻ᴜꜱᴇʀ𓇽
𓇻 ɴᴀᴍᴇ : ${pushname}
𓇻 ɴᴜᴍʙᴇʀ : @${me.split('@')[0]}
𓇻 ᴘʀᴇᴍɪᴜᴍ : ${isPrem ? '✅' : `❌`}
