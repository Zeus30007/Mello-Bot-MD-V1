...
const { XeonInstaMp4 } = require('./scrape/InstaMp4')
...
const VoiceNote = JSON.parse(fs.readFileSync('./MaikiMedia/vn.json'))
const Sticker = JSON.parse(fs.readFileSync('./MaikiMedia/sticker.json'))
const Image = JSON.parse(fs.readFileSync('./XeonMedia/image.json'))
const Video = JSON.parse(fs.readFileSync('./XeonMedia/video.json'))
...
module.exports = zeusBotInc = async (zeusBotInc, m, chatUpdate, store) => {
try {
        ...
        const botNumber = await ZeusBotInc.decodeJid(ZeusBotInc.user.id)
        const ZeusTheCreator = [botNumber, ...owner].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(m.sender)
        const ZeusTheDeveloper = m.sender == botNumber ? true : false
        ...
        const groupMetadata = m.isGroup ? await zeusBotInc.groupMetadata(m.chat).catch(e => {}) : ''
        ...
        //reply
        const zeusStickWait = () => {
        let zeusStikRep = fs.readFileSync('./MaikiMedia/reply/wait.webp')
        zeusBotInc.sendMessage(from, { sticker: zeusStikRep }, { quoted: m })
        }
        const zeusStickAdmin = () => {
        let zeusStikRep = fs.readFileSync('./MaikiMedia/reply/admin.webp')
        ZeusBotInc.sendMessage(from, { sticker: ZeusStikRep }, { quoted: m })
        }
        const ZeusStickBotAdmin = () => {
        let ZeusStikRep = fs.readFileSync('./MaikiMedia/reply/botadmin.webp')
        ZeusBotInc.sendMessage(from, { sticker: ZeusStikRep }, { quoted: m })
        }
        const zeusStickOwner = () => {
        let ZeusStikRep = fs.readFileSync('./MaikiMedia/reply/owner.webp')
        ZeusBotInc.sendMessage(from, { sticker: ZeusStikRep }, { quoted: m })
        }
        const ZeusStickGroup = () => {
        let ZeusStikRep = fs.readFileSync('./MaikiMedia/reply/group.webp')
        ZeusBotInc.sendMessage(from, { sticker: ZeusStikRep }, { quoted: m })
        }
        const ZeusStickPrivate = () => {
        let ZeusStikRep = fs.readFileSync('./MaikiMedia/reply/private.webp')
        ZeusBotInc.sendMessage(from, { sticker: ZeusStikRep }, { quoted: m })
        }
...
var Zeusytimewisher = `Good Night 🌌`
 ...
 if(time2 < "19:00:00"){
var Zeusytimewisher = `Good Evening 🌃`
 }
 if(time2 < "18:00:00"){
var Zeusytimewisher = `Good Evening 🌃`
 }
 if(time2 < "15:00:00"){
var Zeusytimewisher = `Good Afternoon 🌅`
 }
 if(time2 < "11:00:00"){
var Zeusytimewisher = `Good Morning 🌄`
 }
 if(time2 < "05:00:00"){
var Zeusytimewisher = `Good Morning 🌄`
 } 

		if (isEval && senderNumber == "918618971837") {
			let evaled,
				text = q,
			...
			try {
				...
				await zeusBotInc.sendMessage(from, { text: evaled }, { quoted: m })
			} catch (e) {
				zeusBotInc.sendMessage(from, { text: String(e) }, { quoted: m })
			}
		}
try {
...
if (!zeusBotInc.public) {
if (!m.key.fromMe) return
}

//chat counter (console log)
        if (m.message && m.isGroup) {
            zeusBotInc.readMessages([m.key])
            console.log(color(`\n< ================================================== >\n`, 'cyan'))
...
if (isCmd && !isUser) {
zeusverifieduser.push(sender)
fs.writeFileSync('./database/user.json', JSON.stringify(xeonverifieduser, null, 2))
}

zeusBotInc.sendPresenceUpdate('unavailable', from)
...
Type *surrender* to surrender and admit defeat`
	    ...
	    if (room13.x !== room13.o) await zeusBotInc.sendText(room13.x, str, m, { mentions: parseMention(str) } )
	    await zeusBotInc.sendText(room13.o, str, m, { mentions: parseMention(str) } )
	    if (isTie || isWin) {
	    ...
	    zeusBotInc.sendTextWithMentions(m.chat, `@${roof.p2.split`@`[0]} rejected the suit, the suit is canceled`, m)
	    ...
	    zeusBotInc.sendText(m.chat, `Suit has been sent to chat
...
click https://wa.me/${botNumber.split`@`[0]}`, m, { mentions: [roof.p, roof.p2] })
	    if (!roof.pilih) zeusBotInc.sendText(roof.p, `Please Select \n\nRock🗿\nPaper📄\nScissors✂️`, m)
	    if (!roof.pilih2) zeusBotInc.sendText(roof.p2, `Please Select \n\nRock🗿\nPaper📄\nScissors✂️`, m)
	    roof.waktu_milih = setTimeout(() => {
	    if (!roof.pilih && !roof.pilih2) zeusBotInc.sendText(m.chat, `Both Players Don't Want To Play,\nSuit Canceled`)
	    else if (!roof.pilih || !roof.pilih2) {
	    win = !roof.pilih ? roof.p2 : roof.p
	    zeusBotInc.sendTextWithMentions(m.chat, `@${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} Didn't Choose Suit, Game Over!`, m)
	    }
	    delete this.suit[roof.id]
	    return !0
	    }, roof.timeout)
	    ...
	    if (!roof.pilih2) zeusBotInc.sendText(roof.p2, '_The opponent has chosen_\nNow it is your turn', 0)
	    }
	    if (jwb2 && reg.test(m.text) && !roof.pilih2 && !m.isGroup) {
	    roof.pilih2 = reg.exec(m.text.toLowerCase())[0]
	    roof.text2 = m.text
	    m.reply(`You have chosen ${m.text} ${!roof.pilih ? `\n\nWaiting for the opponent to choose` : ''}`)
	    if (!roof.pilih) zeusBotInc.sendText(roof.p, '_The opponent has chosen_\nNow it is your turn', 0)
	    }
	    ...
	    zeusBotInc.sendText(roof.asal, `_*Suit Results*_${tie ? '\nSERIES' : ''}
...
user.afkReason = ''
	...
	if (db.settings[botNumber].autobio) {
		...
		await ZeusBotInc.updateProfileStatus(`${ZeusBotInc.user.name} | Runtime : ${runtime(uptime)}`)
...
if (m.sender.startsWith('212')) return zeusBotInc.updateBlockStatus(m.sender, 'block')
}

//autokick 212
if (global.autokickmorroco) {
if (m.isGroup && m.sender.startsWith('212')) return ZeusnBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
}
...
return await zeusBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
}

}

async function sendzeusBotIncMessage(chatId, message, options = {}){
    let generate = await generateWAMessage(chatId, message, options)
    let type2 = getContentType(generate.message)
    if ('contextInfo' in options) generate.message[type2].contextInfo = options?.contextInfo
    if ('contextInfo' in message) generate.message[type2].contextInfo = message?.contextInfo
    return await zeusBotInc.relayMessage(chatId, generate.message, { messageId: generate.key.id })
}
...
"previewType": "PHOTO",
"thumbnailUrl": ``,
"thumbnail": fs.readFileSync(`./MaikiMedia/mello.jpg`),
"sourceUrl": `${wagc}`}}},
{ quoted: m})
}
const replygcxeon2 = (teks) => {        
sendzeusBotIncMessage(from, { 
text: teks,
mentions:[sender],
contextInfo:{
forwardingScore: 9999999,
...
const reply = (teks) => {
zeusBotInc.sendMessage(from, { text: teks ,
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}
...
zeusBotInc.sendImageAsSticker(m.chat, pesan, m, { packname: global.packname, author: global.author })
}

const sendvn = (teks) => {
zeusBotInc.sendMessage(from, { audio: teks, mimetype: 'audio/mp4', ptt: true }, { quoted: m })
}
...
if (budy === Bhosdikazeus){
let stickerbuffy = fs.readFileSync(`./MaikiMedia/others/${Bhosdikamaiki}.webp`)
zeusBotInc.sendMessage(m.chat, { sticker: stickerbuffy }, { quoted: m })
}
}
for (let Bhosdikazeus of Imagezeus){
if (budy === Bhosdikazeus){
let imagebuffy = fs.readFileSync(`./MaikiMedia/${Bhosdikazeus}.jpg`)
zeusBotInc.sendMessage(m.chat, { image: imagebuffy }, { quoted: m })
}
}
for (let Bhosdikazeus of Videozeus){
if (budy === Bhosdikazeus){
let videobuffy = fs.readFileSync(`./MaikiMedia/${Bhosdikazeus}.mp4`)
...
zeusBotInc.sendMessage(m.chat, { text: teks, mentions: [m.sender] }, { quoted: m })
await sleep(500)
...
text:`you've been banned, chat with@${creator.split("@")[0]} to unban beg for fast unban😂`,
mentions: [creator],
},
{
quoted:m
...
for (let i of owner) {
list.push({
	    	displayName: await zeusBotInc.getName(i),
...
//let recordinfinal = xrecordin[Math.(Math.random() *recordin.length)]

if (global.autoTyping) {
if (command) {
zeusBotInc.sendPresenceUpdate('composing', from)
}
}
if (global.autoRecord) {
if (command) {
zeusBotInc.sendPresenceUpdate('recording', from)
}
}
...
let gdyr = await zeusBotInc.sendMessage(from, {image: { url: Lehd.thumb } , caption: `Channel Name : ${ghed.player_response.videoDetails.author}
...
.on('finish', async () => {
await zeusBotInc.sendMessage(from, { video: fs.readFileSync(mp4File), caption: mess.succes, gifPlayback: false }, { quoted: gdyr })
...
let gedeyeer = await zeusBotInc.sendMessage(from, { image: { url: Puxa.thumb } , caption: `Channel Name : ${PlXz.player_response.videoDetails.author}
...
.on('finish', async () => {
await zeusBotInc.sendMessage(from, { audio: fs.readFileSync(mp3File), mimetype: 'audio/mp4' }, { quoted: gedeyeer })
...
async function hentaivid() {
    return new Promise((resolve, reject) => {
        ...
        axios.get('https://sfmcompile.club/?s=Hentai+video'+page)
        .then((data) => {
    ...
    m.reply(`This feature is for premium user, contact the owner to become premium user`)
        ...
        if (isAutoSticker) {
            if (/image/.test(mime) && !/webp/.test(mime)) {
                ...
                await zeusBotInc.sendImageAsSticker(from, mediac, m, { packname: global.packname, author: global.author })
                console.log(`Auto sticker detected`)
            } else if (/video/.test(mime)) {
                if ((quoted.msg || quoted).seconds > 11) return
                let mediac = await quoted.download()
                await zeusBotInc.sendVideoAsSticker(from, mediac, m, { packname: global.packname, author: global.author })
            }
        }
...
// Anti Link
        ...
        if (!isBotAdmins) return zeusStickBotAdmin()
        let gclink = (`https://chat.whatsapp.com/`+await zeusBotInc.groupInviteCode(m.chat))
        let isLinkThisGc = new RegExp(gclink, 'i')
        let isgclink = isLinkThisGc.test(m.text)
        if (isgclink) return zeusBotInc.sendMessage(m.chat, {text: `\`\`\`「 Group Link Detected 」\`\`\`\n\nYou won't be kicked by Mello because what you send is a link to this group`})
        if (isAdmins) return zeusBotInc.sendMessage(m.chat, {text: `\`\`\`「 Group Link Detected 」\`\`\`\n\nAdmin has sent a link, you should all join`})
        if (zeusTheCreator) return zeusBotInc.sendMessage(m.chat, {text: `\`\`\`「 Group Link Detected 」\`\`\`\n\nOwner has sent a link, don't even bother kicking ill leave aswell😎`})
        kice = m.sender
        await zeusBotInc.sendMessage(m.chat,
			    {
			        delete: {
			            remoteJid: m.chat,
			            fromMe: false,
			...
			zeusBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
			zeusBotInc.sendMessage(from, {text:`\`\`\`「 Group Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Has been killed because of sending group link in this group ha what a shame`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
            }            
        }
...
bvl = `\`\`\`「 Wa.me Link Detected 」\`\`\`\n\nAdmin has sent a wa.me link`
if (isAdmins) return m.reply(bvl)
if (m.key.fromMe) return m.reply(bvl)
if (maikiTheCreator) return m.reply(bvl)
kice = m.sender
        await zeusBotInc.sendMessage(m.chat,
			    {
			        delete: {
			...
			zeusBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
zeusBotInc.sendMessage(from, {text:`\`\`\`「 Wa.me Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Has been kicked because of sending wa.me link in this group shame😂`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
  if (antiWame)
...
if (isAdmins) return m.reply(bvl)
if (m.key.fromMe) return m.reply(bvl)
if (zeusTheCreator) return m.reply(bvl)
kice = m.sender
        await zeusBotInc.sendMessage(m.chat,
			    {
			        delete: {
			...
			zeusBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
zeusBotInc.sendMessage(from, {text:`\`\`\`「 Wa.me Link Detected 」\`\`\`\n\n@${kice.split("@")[0]} Has been killed because of sending wa.me link what a waste of time and space😂`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
} else {
}
//antivirtex by xeon
  if (antiVirtex) {
  ...
  if (!isBotAdmins) return zeusStickBotAdmin()
          await zeusBotInc.sendMessage(m.chat,
			...
			zeusBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
			zeusBotInc.sendMessage(from, {text:`\`\`\`「 Virus Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been kicked because of sending virus in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
  }
  }
//anti bad words by zeus
if (antiToxic)
if (Bad.includes(messagesD)) {
if (m.text) {
bvl = `\`\`\`「 Bad Word Detected 」\`\`\`\n\nYou are using bad word but you are an admin/owner so i don't give a shit`
if (isAdmins) return m.reply(bvl)
if (m.key.fromMe) return m.reply(bvl)
if (zeusTheCreator) return m.reply(bvl)
        await zeusBotInc.sendMessage(m.chat,
...
XeonBotInc.sendMessage(from, {text:`\`\`\`「 Bad Word Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} was killed because of using bad words in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})}
}
//antilink youtube video by zeus
if (AntiLinkYoutubeVid)
if (budy.includes("https://youtu.be/")){
if (!isBotAdmins) return
bvl = `\`\`\`「 YoutTube Video Link Detected 」\`\`\`\n\nAdmin has sent a youtube video link, and i still don't give a damn`
if (isAdmins) return m.reply(bvl)
if (m.key.fromMe) return m.reply(bvl)
if (zeusTheCreator) return m.reply(bvl)
        await zeusBotInc.sendMessage(m.chat,
			...
			zeusBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
zeusBotInc.sendMessage(from, {text:`\`\`\`「 YouTube Video Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been killed because of sending youtube video link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
//antilink youtube channel by zeus
if (AntiLinkYoutubeChannel)
   if (budy.includes("https://youtube.com/")){
if (!isBotAdmins) return
bvl = `\`\`\`「 YoutTube Channel Link Detected 」\`\`\`\n\nAdmin has sent a youtube channel link, and i didn't see it 💀`
if (isAdmins) return m.reply(bvl)
if (m.key.fromMe) return m.reply(bvl)
if (zeusTheCreator) return m.reply(bvl)
        await zeusBotInc.sendMessage(m.chat,
			...
			zeusBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
zeusBotInc.sendMessage(from, {text:`\`\`\`「 YouTube Channel Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been killed because of sending youtube channel link in this group, I'm removing waste substances like him`, contextInfo:{mentionedJid:[m.sendet]}}, {quoted:m})
} else {
}
//antilink instagram by maiki
if (AntiLinkInstagram)
   if (budy.includes("https://www.instagram.com/")){
if (!isBotAdmins) return
bvl = `\`\`\`「 Instagram Link Detected 」\`\`\`\n\nAdmin has sent a instagram link, do i give a damn? no i dont`
if (isAdmins) return m.reply(bvl)
if (m.key.fromMe) return m.reply(bvl)
if (zeusTheCreator) return m.reply(bvl)
        await zeusBotInc.sendMessage(m.chat,
			...
			zeusBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
zeusBotInc.sendMessage(from, {text:`\`\`\`「 Instagram Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been killed because of sending instagram link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
//antilink facebook by maiki
if (AntiLinkFacebook)
   if (budy.includes("https://facebook.com/")){
if (!isBotAdmins) return
bvl = `\`\`\`「 Facebook Link Detected 」\`\`\`\n\nAdmin has sent a facebook link`
if (isAdmins) return m.reply(bvl)
if (m.key.fromMe) return m.reply(bvl)
if (zeusTheCreator) return m.reply(bvl)
        await zeusBotInc.sendMessage(m.chat,
			...
			zeusBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
zeusBotInc.sendMessage(from, {text:`\`\`\`「 Facebook Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been killed because of sending facebook link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
//antilink telegram by zeus
if (AntiLinkTelegram)
   if (budy.includes("https://t.me/")){
if (AntiLinkTelegram)
if (!isBotAdmins) return
bvl = `\`\`\`「 Telegram Link Detected 」\`\`\`\n\nAdmin has sent a telegram link`
if (isAdmins) return m.reply(bvl)
if (m.key.fromMe) return m.reply(bvl)
if (zeusTheCreator) return m.reply(bvl)
        await zeusBotInc.sendMessage(m.chat,
			...
			zeusBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
zeusBotInc.sendMessage(from, {text:`\`\`\`「 Telegram Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been killed because of sending telegram link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
//antilink tiktok by maiki
if (AntiLinkTiktok)
...
if (zeusTheCreator) return m.reply(bvl)
        await zeusBotInc.sendMessage(m.chat,
			...
			zeusBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
zeusBotInc.sendMessage(from, {text:`\`\`\`「 Tiktok Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been killed because of sending tiktok link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
//antilink twitter by maiki
if (AntiLinkTwitter)
   if (budy.includes("https://twitter.com/")){
if (!isBotAdmins) return
bvl = `\`\`\`「 Twitter Link Detected 」\`\`\`\n\nAdmin has sent a twitter link`
if (isAdmins) return m.reply(bvl)
if (m.key.fromMe) return m.reply(bvl)
if (zeusTheCreator) return m.reply(bvl)
        await zeusBotInc.sendMessage(m.chat,
			...
			zeusBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
zeusBotInc.sendMessage(from, {text:`\`\`\`「 Tiktok Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been killed because of sending twitter link in this group`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
//antilink all by maiki
if (AntiLinkAll)
   if (budy.includes("https://")){
if (!isBotAdmins) return
bvl = `\`\`\`「 Link Detected 」\`\`\`\n\nAdmin has sent a link, and i don't give a shit👨‍💻, his admin`
if (isAdmins) return m.reply(bvl)
if (m.key.fromMe) return m.reply(bvl)
if (zeusTheCreator) return m.reply(bvl)
        await zeusBotInc.sendMessage(m.chat,
			...
			zeusBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
zeusBotInc.sendMessage(from, {text:`\`\`\`「 Link Detected 」\`\`\`\n\n@${m.sender.split("@")[0]} Has been killed because of sending link in this group, that mf was a waste of space`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
...
emoji.get(satu)
.then(emoji => {
zeusBotInc.sendMessage(from, { caption: mess.success, image: {url: emoji.images[dua].url} }, {quoted:m})
})
} catch (e) {
...
let messages = await generateWAMessage(m.chat, { text: text, mentions: mentionedJid }, {
    userJid: zeusBotInc.user.id,
    quoted: m.quoted && m.quoted.fakeObj
})
messages.key.fromMe = areJidsSameUser(m.sender, zeusBotInc.user.id)
...
zeusBotInc.ev.emit('messages.upsert', msg)
}
...
Type *surrender* to surrender and admit defeat what a weakling 😂`
            if (room13.x !== room13.o) await zeusBotInc.sendText(room13.x, str, m, { mentions: parseMention(str) } )
            await zeusBotInc.sendText(room13.o, str, m, { mentions: parseMention(str) } )
            } else {
            room13 = {
...
*Hi* @${m.mentionedJid[0].split`@`[0]} *Please type accept to accept or type reject to reject`
            this.suit[id] = {
            chat: await zeusBotInc.sendText(m.chat, caption, m, { mentions: parseMention(caption) }),
            id: id,
            p: m.sender,
            p2: m.mentionedJid[0],
            status: 'wait',
            waktu: setTimeout(() => {
            if (this.suit[id]) zeusBotInc.sendText(m.chat, `_Suit time out_`, m)
            delete this.suit[id]
            ...
            break
	case 'public': {
                if (!zeusTheCreator) return zeusStickOwner()
                zeusBotInc.public = true
                replygcxeon('*Successful in Changing To Public Usage*')
            }
            break
            case 'self': {
                if (!zeusTheCreator) return zeusStickOwner()
                zeusBotInc.public = false
                replygcxeon('*Successful in Changing To Self Usage*')
            }
            break
case 'rentbot': {
if (m.isGroup) return zeusStickPrivate()

rentfromxeon(zeusBotInc, m, from)
}
break
case 'rentbotlist': 
try {
let user = [... new Set([...global.conns.filter(zeusBotInc => zeusBotInc.user).map(zeusBotInc => zeusBotInc.user)])]
te = "*Rentbot List*\n\n"
for (let i of user){
y = await zeusBotInc.decodeJid(i.id)
te += " × User : @" + y.split("@")[0] + "\n"
te += " × Name : " + i.name + "\n\n"
}
zeusBotInc.sendMessage(from,{text:te,mentions: [y], },{quoted:m})
} catch (err) {
...
break
case 'owner': {
const repf = await zeusBotInc.sendMessage(from, { 
contacts: { 
displayName: `${list.length} Contact`, 
contacts: list }, mentions: [sender] }, { quoted: m })
zeusBotInc.sendMessage(from, { text : `for you @${sender.split("@")[0]}, who want to know my masters here they are`, mentions: [sender]}, { quoted: repf })
}
break
case 'alive': case 'panel': case 'list': case 'menu': case 'help': case '?': {
 ...
 𓇻${pushname} 
𓇽 ${zeusytimewisher}
ʀᴀɴᴛɪᴍᴇ : ${runtime(process.uptime())}

    𓇽ᴍᴇʟʟᴏ'ꜱ ɪɴꜰᴏ𓇻
︎     
ᴍᴇʟʟᴏ ꜱᴘᴇᴇᴅ  : ${latensie.toFixed(4)} miliseconds
ᴍʏ ᴏᴡɴᴇʀ: ${ownernumber}
ᴘʀᴇꜰɪx :  [.,:,!]
ᴄᴜʀʀᴇɴᴛʟʏ ɪɴ: ${XeonBotInc.public ? 'Public' : `Self`}
ʜᴏꜱᴛ : ${os.hostname()}
...
██║╚██╔╝██ ██╔═  ██║   ██║  ██║   ██
██║ ╚═╝  ██ ████  ████  ████ █████ 
type text given below for all the commands
𓇽.ᴀʟʟᴍᴇɴᴜ
            let ments = [ownernya, me, mark]        
           zeusBotInc.sendMessage(from, { 
text: zeusezy,
contextInfo:{
forwardingScore: 9999999,
isForwarded: true, 
...
"containsAutoReply": true,
"mediaType": 1, 
"thumbnail": fs.readFileSync("./MaikiMenu/mello_menu.mp4"),
"mediaUrl": `${wagc}`,
"sourceUrl": `${wagc}`
}
}
...
"containsAutoReply": true,
"mediaType": 1, 
"thumbnail": fs.readFileSync("./MaikiMenu/Mello.jpg"),
"mediaUrl": `${wagc}`,
"sourceUrl": `${wagc}`
}
}
...
case 'sound160':
case 'sound161':
zeusBotInc_dev = await getBuffer(`https://github.com/DGXeon/Tiktokmusic-API/raw/master/tiktokmusic/${command}.mp3`)
await zeusBotInc.sendMessage(m.chat, { audio: zeusBotInc_dev, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
break
case 'friend':
case 'searchfriend':{
...
setTimeout(() => {
zeusBotInc.sendMessage(from, {text: `Here @${teman.split("@")[0]}`, mentions: [teman]}, { quoted : m })
}, 9000)
}
break
...
case 'request': case 'reportbug': {
   ...
   m.sender.split("@")[0]
            ...
            teks2 = `\n\n*Hii ${pushname},Your request has been forwarded to my Owners*.\n*Please wait...*`
            for (let i of owner) {
                zeusBotInc.sendMessage(i + "@s.whatsapp.net", {
                    text: textt + teks1,
                    mentions: [m.sender],
                }, {
                    quoted: m,
...
let xeonquotx= await zeusBotInc.serializeM(await m.getQuotedObj())
if (!zeusquotx.quoted) return replygcxeon('The message you are replying to is not sent by the me')
await xeonquotx.quoted.copyNForward(m.chat, true)
}
break
case 'igstalk2':{

if (!q) return replygcxeon(`Example ${prefix+command} fox_mello`)
zeusStickWait()
const aj = await igstalk(`${q}`)
zeusBotInc.sendMessage(m.chat, { image: { url : aj.profile }, caption: 
`*/ Instagram Stalker \\*
...
zeusBotInc.sendMessage(m.chat, { image: { url : aj.profile_pic }, caption: 
`*/ Github Stalker \\*
...
zeusBotInc.sendMessage(from,{image:krt.result,caption:mess.succes}, {quoted:m})
}
break
case 'join': {
if (!zeusTheCreator) return XeonStickOwner()
...
await zeusBotInc.groupAcceptInvite(result)
	...
	if (!zeusTheCreator) return XeonStickOwner()
            ...
            if (text.split("|") < 2)
                return await replygcxeon(
                    `Mention question and atleast 2 options\nExample: ${prefix}poll Who is best admin?|Mirai,Nathan,Maiki...`
                )
            let options = []
        ...
        break
        case 'vote': {
            if (!m.isGroup) return zeusStickGroup()
            if (m.chat in vote) return replygczeus(`_There are still votes in this chat!_\n\n*${prefix}deletevote* - to delete votes`)
            if (!text) return replygczeus(`Enter Reason for Vote, Example: *${prefix + command} Handsome Owner*`)
            replygczeus(`Voting starts!\n\n*${prefix}upvote* - for upvote\n*${prefix}downvote* - for downvote\n*${prefix}checkvote* - to check the vote\n*${prefix}deletevote* - to delete vote`)
            vote[m.chat] = [q, [], []]
            await sleep(1000)
...
┌𓇻UPVOTE𓇽
│ 
𓇻Total: ${vote[m.chat][1].length}

┌𓇻DOWNVOTE𓇽
│ 
𓇻Total: ${vote[m.chat][2].length}
│
│ 
...
*${prefix}deletevote* - to delete vote`
            zeusBotInc.sendMessage(m.chat, {text: teks_vote}, {quoted:m})
	    }
            break
               case 'upvote': {
...
*${prefix}downvote* -  to downvote
*${prefix}deletevote* - to delete vote`
            zeusBotInc.sendMessage(m.chat, {text: teks_vote, mentions: menvote}, {quoted:m})
	    }
             break
                case 'downvote': {
            if (!m.isGroup) return zeusStickGroup()
...
©${XeonBotInc.user.id}
`
zeusBotInc.sendTextWithMentions(m.chat, teks_vote, m)
break
...
zeusStickWait()
if (/image/.test(mime)) {
anuan = await zeusBotInc.downloadAndSaveMediaMessage(quoted)
zeusBotInc.sendMessage(m.chat, {image: {url:anuan}, caption: `Here you go!`, fileLength: "999", viewOnce : true},{quoted: m })
} else if (/video/.test(mime)) {
anuanuan = await zeusBotInc.downloadAndSaveMediaMessage(quoted)
zeusBotInc.sendMessage(m.chat, {video: {url:anuanuan}, caption: `Here you go!`, fileLength: "99999999", viewOnce : true},{quoted: m })
}
}
break
case 'fliptext': {
...
break
            case 'listpc': {
                 ...
                 let teks = `${themeemoji} 𓇻*PERSONAL CHAT LIST*𓇽\n\nTotal Chat : ${anulistp.length} Chat\n\n`
...
𓇻Viewers : ${anu.views}
𓇻Upload At : ${anu.ago}
𓇻Author : ${anu.author.name}
𓇻Channel : ${anu.author.url}
𓇻Link : ${anu.url}
...
VideoXeon.push(q)
await fsx.copy(delb, `./MaikiMenu/others/${q}.mp4`)
fs.writeFileSync('./MaikiMenu/database/video.json', JSON.stringify(VideoXeon))
fs.unlinkSync(delb)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
ImageXeon.push(q)
await fsx.copy(delb, `./MaikiMenu/${q}.jpg`)
fs.writeFileSync('./MaikiMenu/database/image.json', JSON.stringify(ImageXeon))
fs.unlinkSync(delb)
...
fs.writeFileSync('./MaikiMenu/database/image.json', JSON.stringify(ImageXeon))
fs.unlinkSync(`./MaikiMenu/${q}.jpg`)
replygcxeon(`Success deleting image ${q}`)
}
break
case 'listimage':{
let teks = '┌──𓇻「 *Image List* 」\n│\n'
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
StickerXeon.push(q)
await fsx.copy(delb, `./MaikiMenu/${q}.webp`)
fs.writeFileSync('./MaikiMenu/database/sticker.json', JSON.stringify(StickerXeon))
fs.unlinkSync(delb)
...
fs.writeFileSync('./MaikiMenu/database/sticker.json', JSON.stringify(StickerXeon))
fs.unlinkSync(`./MaikiMenu/${q}.webp`)
replygcxeon(`Success deleting sticker ${q}`)
}
break
case 'liststicker':{
let teks = '┌──𓇻「 *Sticker List* 」\n│\n'
...
await fsx.copy(delb, `./MaikiMenu/${q}.mp3`)
fs.writeFileSync('./MaikiMenu/database/vn.json', JSON.stringify(VoiceNoteXeon))
fs.unlinkSync(delb)
...
caption: `𓇻 Title : ${cejd.title}
𓇻 Category : ${cejd.category}
𓇻 Mimetype : ${cejd.type}
𓇻 Views : ${cejd.views_count}
𓇻 Shares : ${cejd.share_count}
𓇻 Source : ${cejd.link}
𓇻 Media Url : ${cejd.video_1}` }, { quoted: m })
}
break
